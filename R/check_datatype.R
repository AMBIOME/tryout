...
check_PhysicalChemical <- function(data, level = "error") {
    ...
    errors <- data_frame()
    required <- c("visit_year","station_name","reported_station_name","sample_project_name_sv","sample_orderer_name_sv","platform_code","visit_id","expedition_id","visit_date","shark_sample_id","sample_time","sample_enddate","sample_endtime","sample_latitude_dm","sample_longitude_dm","sample_latitude_dd","sample_longitude_dd","positioning_system_code","water_depth_m","wind_direction_code","wind_speed_ms","air_temperature_degc","air_temperature_wet_degc","air_pressure_hpa","weather_observation_code","cloud_observation_code","wave_observation_code","ice_observation_code","secchi_depth_m","secchi_depth_quality_flag","additional_sampling","visit_comment","sample_id","sample_depth_m","sample_comment","parameter","value","unit","quality_flag","analysis_method_code","method_reference_code","variable_comment","estimation_uncertainty","method_calculation_uncertainty","quantification_limit","detection_limit","analysis_range","analytical_laboratory_name_sv","analytical_laboratory_accreditated","sampler_type_code_phyche","sampling_method_reference_code_phyche","sampling_method_comment_phyche","sampling_laboratory_code_phyche","sampling_laboratory_accreditated_phyche","station_viss_eu_id","monitoring_program_code","reporting_institute_name_sv","data_holding_centre","internet_access","dataset_name","dataset_file_name")
    recommended <- c()
...
check_Zoobenthos <- function(data, level = "error") {
    ...
    errors <- data_frame()
    required <- c("delivery_datatype","check_status_sv","data_checked_by_sv","visit_year","station_name","reported_station_name","station_cluster","sample_project_name_sv","sample_orderer_name_sv","platform_code","visit_id","shark_sample_id_md5","sample_date","sample_time","sample_latitude_dm","sample_longitude_dm","sample_latitude_dd","sample_longitude_dd","positioning_system_code","water_depth_m","wind_direction_code","wind_speed_ms","air_temperature_degc","air_pressure_hpa","weather_observation_code","cloud_observation_code","wave_observation_code","wave_height_m","ice_observation_code","secchi_depth_m","secchi_depth_quality_flag","visit_comment","sediment_type","sample_id","sample_min_depth_m","sample_max_depth_m","sampling_laboratory_name_sv","sampling_laboratory_accreditated","sampler_type_code","sampled_volume_l","sampler_area_cm2","sample_comment","scientific_name","species_flag_code","dyntaxa_id","parameter","value","unit","quality_flag","calc_by_dc","dev_stage_code","sample_part_id","taxonomist","method_documentation","method_reference_code","fauna_flora_found","factors_influencing_code","variable_comment","analytical_laboratory_name_sv","analytical_laboratory_accreditated","analysed_by","analysis_date","preservation_method_code","upper_mesh_size_um","lower_mesh_size_um","number_of_portions","counted_portions","sample_part_min_cm","sample_part_max_cm","station_viss_eu_id","water_land_station_type_code","monitoring_station_type_code","monitoring_purpose_code","monitoring_program_code","reported_scientific_name","reported_parameter","reported_value","reported_unit","reporting_institute_name_sv","data_holding_centre","internet_access","dataset_name","dataset_file_name")
    recommended <- c()
...
check_Zooplankton <- function(data, level = "error") {
    ...
    errors <- data_frame()
    required <- c("delivery_datatype","check_status_sv","data_checked_by_sv","visit_year","station_name","reported_station_name","sample_project_name_sv","sample_orderer_name_sv","platform_code","visit_id","expedition_id","shark_sample_id_md5","sample_date","sample_time","sample_latitude_dm","sample_longitude_dm","sample_latitude_dd","sample_longitude_dd","positioning_system_code","water_depth_m","wind_direction_code","wind_speed_ms","air_temperature_degc","air_pressure_hpa","weather_observation_code","cloud_observation_code","wave_observation_code","ice_observation_code","secchi_depth_m","secchi_depth_quality_flag","visit_comment","sample_id","sample_min_depth_m","sample_max_depth_m","sampling_laboratory_name_sv","sampling_laboratory_accreditated","sampler_type_code","sampled_volume_l","sampler_area_cm2","wire_angle_deg","plankton_sampling_method_code","flowmeter_length_m","sample_comment","scientific_name","species_flag_code","dyntaxa_id","parameter","value","unit","quality_flag","calc_by_dc","sex_code","dev_stage_code","size_class","size_min_um","size_max_um","sample_part_id","taxonomist","method_documentation","method_reference_code","calculation_method","sample_splitting_code","variable_comment","analytical_laboratory_name_sv","analytical_laboratory_accreditated","analysed_by","analysis_date","preservation_method_code","mesh_size_um","number_of_portions","counted_portions","magnification","station_viss_eu_id","water_land_station_type_code","monitoring_station_type_code","monitoring_purpose_code","monitoring_program_code","reported_scientific_name","reported_parameter","reported_value","reported_unit","reporting_institute_name_sv","data_holding_centre","internet_access","dataset_name","dataset_file_name")
    recommended <- c()
